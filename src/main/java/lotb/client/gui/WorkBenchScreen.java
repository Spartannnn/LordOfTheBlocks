...
@OnlyIn(Dist.CLIENT)
public class WorkBenchScreen extends ContainerScreen<RohanWorkBenchContainer> {
	...
	public WorkBenchScreen(RohanWorkBenchContainer containerIn, PlayerInventory playerInv, ITextComponent titleIn) {
		super(containerIn, playerInv, titleIn);
		LOGGER.debug("new screen made <<-------");
