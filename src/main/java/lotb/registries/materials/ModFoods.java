...
public class ModFoods {
	...
	public static final Food LEMBAS					= (new Food.Builder()).hunger(7).saturation(1.0F).build();
	public static final Food CRAM					= (new Food.Builder()).hunger(4).saturation(1.3F).build();
