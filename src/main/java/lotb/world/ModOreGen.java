...
public class ModOreGen {
	...
	public static void addModOres(Biome biome) {
		OreFeatureConfig prismarineOreFeature	= new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,ModBlocks.PRISMARINE_ORE.getDefaultState(),12);
		OreFeatureConfig quartzOreFeature 		= new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,ModBlocks.QUARTZ_ORE.getDefaultState(),8);
		OreFeatureConfig glowstoneOreFeature 	= new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,ModBlocks.GLOWSTONE_ORE.getDefaultState(),7);
	...
	public static void addMithril(Biome biome) {
		OreFeatureConfig mithrilOreFeature 		= new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,ModBlocks.MITHRIL_ORE.getDefaultState(),9);
